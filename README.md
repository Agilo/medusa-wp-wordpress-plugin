...
WordPress is now available at https://medusa-wp.test and Medusa Admin dashboard at http://localhost:9000/app.
...
- `nginx` - Nginx web server that serves WordPress on https://medusa-wp.test
- `php` - PHP-FPM
