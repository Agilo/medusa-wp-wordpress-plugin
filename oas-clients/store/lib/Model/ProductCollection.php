...
/**
 * ProductCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductCollection';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The product collection's ID
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title The title that the Product Collection is identified by.
     *
     * @return self
     */
     ...
     * Sets handle
     *
     * @param string $handle A unique string that identifies the Product Collection - can for example be used in slug structures.
     *
     * @return self
     */
     ...
     * Sets products
     *
     * @param \MedusaWP\MedusaClient\Store\Model\Product[]|null $products The details of the products that belong to this product collection.
     *
     * @return self
     */
