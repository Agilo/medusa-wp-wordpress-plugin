...
/**
 * FulfillmentItem Class Doc Comment
 *
 * @category Class
 ...
 */
class FulfillmentItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FulfillmentItem';
    ...
    */
     ...
     * Sets fulfillment_id
     *
     * @param string $fulfillment_id The ID of the Fulfillment that the Fulfillment Item belongs to.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the Line Item that the Fulfillment Item references.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int $quantity The quantity of the Line Item that is included in the Fulfillment.
     *
     * @return self
     */
