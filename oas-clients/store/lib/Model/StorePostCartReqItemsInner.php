...
/**
 * StorePostCartReqItemsInner Class Doc Comment
 *
 * @category Class
 * @package  MedusaWP\MedusaClient\Store
 * @author   OpenAPI Generator team
 ...
 */
class StorePostCartReqItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorePostCartReq_items_inner';
    ...
    */
     ...
     * Sets quantity
     *
     * @param int $quantity The quantity to add into the cart.
     *
     * @return self
     */
