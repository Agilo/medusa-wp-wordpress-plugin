...
class PriceList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'sale');
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The price list's name
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The price list's description
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of Price List. This can be one of either `sale` or `override`.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The status of the Price List
     *
     * @return self
     */
     ...
     * Sets starts_at
     *
     * @param \DateTime $starts_at The date with timezone that the Price List starts being valid.
     *
     * @return self
     */
     ...
     * Sets ends_at
     *
     * @param \DateTime $ends_at The date with timezone that the Price List stops being valid.
     *
     * @return self
     */
     ...
     *
     * @param \MedusaWP\MedusaClient\Store\Model\CustomerGroup[]|null $customer_groups The details of the customer groups that the Price List can apply to.
     *
     * @return self
     */
     ...
     * Sets prices
     *
     * @param \MedusaWP\MedusaClient\Store\Model\MoneyAmount[]|null $prices The prices that belong to the price list, represented as a Money Amount.
     *
     * @return self
     */
     ...
     * Sets includes_tax
     *
     * @param bool|null $includes_tax Whether the price list prices include tax
     *
     * @return self
     */
