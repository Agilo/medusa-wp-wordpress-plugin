 ...
 */
class ClaimTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClaimTag';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The claim tag's ID
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value The value that the claim tag holds
     *
     * @return self
     */
