...
/**
 * PostCart400Response Class Doc Comment
 *
 * @category Class
 * @package  MedusaWP\MedusaClient\Store
 * @author   OpenAPI Generator team
 ...
 */
class PostCart400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostCart_400_response';
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'type' => 'string',
        'errors' => '\MedusaWP\MedusaClient\Store\Model\Error[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('message', $data ?? [], 'Provided request body contains errors. Please check the data and retry the request');
    ...
    */
     ...
     * Gets errors
     *
     * @return \MedusaWP\MedusaClient\Store\Model\Error[]|null
     */
     ...
     * Sets errors
     *
     * @param \MedusaWP\MedusaClient\Store\Model\Error[]|null $errors Array of errors
     *
     * @return self
     */
