...
class ProductOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'title' => 'string',
        'values' => '\MedusaWP\MedusaClient\Store\Model\ProductOptionValue[]',
        'product_id' => 'string',
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The product option's ID
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title The title that the Product Option is defined by (e.g. `Size`).
     *
     * @return self
     */
     ...
     * Sets values
     *
     * @param \MedusaWP\MedusaClient\Store\Model\ProductOptionValue[]|null $values The details of the values of the product option.
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param string $product_id The ID of the product that this product option belongs to.
     *
     * @return self
     */
