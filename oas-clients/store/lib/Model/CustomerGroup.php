...
class CustomerGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'customers' => '\MedusaWP\MedusaClient\Store\Model\Customer[]',
        'price_lists' => '\MedusaWP\MedusaClient\Store\Model\PriceList[]',
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'deleted_at' => '\DateTime',
        'metadata' => 'object'
    ...
    */
     ...
     * Sets customers
     *
     * @param \MedusaWP\MedusaClient\Store\Model\Customer[]|null $customers The details of the customers that belong to the customer group.
     *
     * @return self
     */
     ...
     * Sets price_lists
     *
     * @param \MedusaWP\MedusaClient\Store\Model\PriceList[]|null $price_lists The price lists that are associated with the customer group.
     *
     * @return self
     */
    public function setPriceLists($price_lists)
    {
        if (is_null($price_lists)) {
            throw new \InvalidArgumentException('non-nullable price_lists cannot be null');
        }
