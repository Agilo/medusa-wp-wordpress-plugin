...
/**
 * ShippingOptionRequirement Class Doc Comment
 *
 * @category Class
 ...
 */
class ShippingOptionRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingOptionRequirement';
    ...
    public const TYPE_MIN_SUBTOTAL = 'min_subtotal';
    public const TYPE_MAX_SUBTOTAL = 'max_subtotal';
    ...
    {
        return [
            self::TYPE_MIN_SUBTOTAL,
            self::TYPE_MAX_SUBTOTAL,
        ];
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The shipping option requirement's ID
     *
     * @return self
     */
     ...
     *
     * @param string $shipping_option_id The ID of the shipping option that the requirements belong to.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the requirement, this defines how the value will be compared to the Cart's total. `min_subtotal` requirements define the minimum subtotal that is needed for the Shipping Option to be available, while the `max_subtotal` defines the maximum subtotal that the Cart can have for the Shipping Option to be available.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int $amount The amount to compare the Cart subtotal to.
     *
     * @return self
     */
